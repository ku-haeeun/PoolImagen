...
SAVE_DIR ='/home/haen/workspace/Imagen_org/CUB/Cub_pool_8/'
CHECK_DIR = '/home/haen/workspace/Imagen_org/CUB/Cub_pool_8/checkpoint_pool_8/'
MODEL_DIR ='/home/haen/workspace/Imagen_org/CUB/CUB_pool_8/model(cub)_pool_8/'
LOG_DIR = '/home/haen/workspace/Imagen_org/CUB/Cub_pool_8/log_dir/train_8'
...
unet1 = Unet(
    ...
    num_resnet_blocks = (1, 2, 4), # each layer add resnet block
...
checkpoint_path = os.path.join(MODEL_DIR, 'model(cub)_pool_8checkpoint_cub_pool_8.pth')
# state_dict load
checkpoint = torch.load(checkpoint_path)
imagen.load_state_dict(checkpoint['model_state_dict'])

#image path
output_test_dir_image = '/home/haen/workspace/Imagen_org/CUB/CUB_pool_8/test_output_pool/'
output_test_dir_text = '/home/haen/workspace/Imagen_org/CUB/CUB_pool_8/test_output_text_pool'
#test
imagen.eval()
