...
SAVE_DIR ='/home/gail1/imagen_celeba/CelebA/result/Output_celeb/'
CHECK_DIR = '/home/gail1/imagen_celeba/CelebA/checkpoint_celeba/'
LOG_DIR = '/home/gail1/imagen_celeba/CelebA/log_dir/train2'
MODEL_DIR ='/home/gail1/imagen_celeba/CelebA/model(celeb)'
...
summary = SummaryWriter(log_dir=os.path.join(LOG_DIR, 'train_celeba'))
    ...
    for epoch in range(n_epochs):
        ...
        if epoch % 10 == 9 or epoch == 0:
            torch.save({
              ...
              'loss': loss.item(),
            }, MODEL_DIR + 'checkpoint_celeba.pth')
