...
SAVE_DIR ='/home/haen/workspace/Imagen_org/CUB/CUB_origin_16/'
...
checkpoint_path = os.path.join(MODEL_DIR, 'checkpoint_cub_16_re.pth')
# state_dict load
checkpoint = torch.load(checkpoint_path)
imagen.load_state_dict(checkpoint['model_state_dict'])

#image path
output_test_dir_image = '/home/haen/workspace/Imagen_org/CUB/CUB_origin_16/test_output'
output_test_dir_text = '/home/haen/workspace/Imagen_org/CUB/CUB_origin_16/test_output_text'
#test
imagen.eval()
